...
./tools/wait-for-rollout.sh deployment productpage-v1 productpage 10 ${cluster1_context}
./tools/wait-for-rollout.sh deployment reviews-v1 reviews 10 ${cluster2_context}
